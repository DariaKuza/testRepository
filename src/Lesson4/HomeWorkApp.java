...
public class HomeWorkApp {
    ...
    public static final int FIELD_SIZE = 5;         // игровое поле
    public static final int DOTS_TO_WIN = 4;        //

    public static final char EMPTY_DOT = '.';       // для пустой ячейки
    public static final char PLAYER_1_DOT = 'X';    //  первый игрок
    public static final char PLAYER_2_DOT = 'O';    //  второй игрок
